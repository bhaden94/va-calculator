...
export const HomePageTextConstants = {
  ...
  slogan:
    "Navigate the complexities of U.S. Veteran benefits with VA Calculators - unleash the full potential of your VA benefits and make informed financial decisions.",
};

export const HomePageTitleText = "VA Calculator";
