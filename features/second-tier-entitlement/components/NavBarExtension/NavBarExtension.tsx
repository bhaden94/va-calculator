...
export const NavBarExtension: FC = () => {
  ...
  const { entitlementUsed, availableEntitlement, downPayment, maxLoanNoDown } =
      ...
      <div style={divStyle}>
        ...
        >
          <div style={collapsableInner}>
            <MoreDetailsRow
              title={NavBarExtensionConstants.countyLimitTitleText}
              amount={
                chosenEntitlementDataState.chosenEntitlementDataRow?.entitlement
              }
            />
            <MoreDetailsRow
              title={NavBarExtensionConstants.entitlementUsedTitleText}
            ...
            />
            <MoreDetailsRow
              title={NavBarExtensionConstants.availableEntitlementTitleText}
