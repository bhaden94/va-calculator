...
export const SecondTierEntitlementWebpageText =
  "VA Calculator - Second Tier Entitlement";
export const SecondTierEntitlementWebpageDescription =
  "The Second tier entitlement calculator for Veterans Affair (VA) home loans.";
